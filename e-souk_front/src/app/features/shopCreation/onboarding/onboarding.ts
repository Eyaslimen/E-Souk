...
import { ProductCreationComponent } from '../product-creation/product-creation';
import { 
  OnboardingState, 
  OnboardingStep, 
  ...
  async confirmShopCreation(): Promise<void> {
    ...
    try {
      const shopRequestData: CreateShopRequestDTO = {
        ...
        bio:this.pendingShopData.bio,
        description: this.pendingShopData.description,
        categoryName:this.pendingShopData.categoryName,
        deliveryFee: this.pendingShopData.deliveryFee,
        address: this.pendingShopData.address,
        phone:this.pendingShopData.phone,
        instagramLink:this.pendingShopData.instagramLink,
        facebookLink:this.pendingShopData.facebookLink,
